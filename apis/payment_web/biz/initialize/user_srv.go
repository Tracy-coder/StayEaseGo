...
func InitUserSrv() {
	...
	services, _, err := consulClient.Health().Service(global.GlobalServerConfig.UserSrv.Name, "StayEaseGo", true, nil)
	if err != nil {
	...
	grpcClient := pb.NewUserClient(grpcConn)
	global.UserSrvClient = grpcClient
}
