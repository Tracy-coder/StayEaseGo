...
import (
	"StayEaseGo/srvs/order_srv/initialize"
	"flag"
	"fmt"
	"net"
	"os"
...
func main() {
	...
	ctx := &handler.ServiceContext{
		...
		HomestaySrvClient: global.HomestaySrvClient,
	}
	proto.RegisterOrderServer(server, handler.NewOrderSever(ctx))
